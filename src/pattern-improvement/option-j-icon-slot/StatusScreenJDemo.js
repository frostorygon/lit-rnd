/**
 * Demo for Option J — shows error AND success using the same component.
 * The consumer provides the icon via slot.
 */
...
export class StatusScreenJDemo extends LocalizeMixin(LitElement) {
  static properties = {
  ...
  _somethingWentWrong() {
    return html`
      <status-screen-j variant="error">
        <lottie-player slot="icon" autoplay icon="error"></lottie-player>
  ...
  _linkedAccount() {
    return html`
      <status-screen-j variant="warning">
        <lottie-player slot="icon" autoplay icon="warning"></lottie-player>
  ...
  _transactionPending() {
    return html`
      <status-screen-j variant="info">
        <lottie-player slot="icon" autoplay icon="info"></lottie-player>
  ...
  // ─── Success variant — SAME component, different content ───

  _success() {
    return html`
      <status-screen-j variant="success">
        <lottie-player slot="icon" autoplay icon="success"></lottie-player>
...
customElements.define('status-screen-j-demo', StatusScreenJDemo);
